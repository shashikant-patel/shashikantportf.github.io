...
?>
  ...
  <option value="pe">Pofessional Experience</option>
    ...
    <input type="text" name="title" class="form-control" id="website" placeholder="Bachelor of Technology" required>
  </div>
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" class="form-control" id="website" placeholder="Working at space-X. , USA " required>
  </div>
   <div class="form-group col-md-4">
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <option value="pe" selected>Pofessional Experience</option>
                    <?php    }
                     ...
                     <div class="form-group col-md-8">
    <label for="sn">Course/Position Name</label>
    <input type="text" name="title" value="<?=$data2['title']?>" class="form-control" id="website" placeholder="Bachelor of Technology" required>
  </div>
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" value="<?=$data2['ogname']?>" class="form-control" id="website" placeholder="Working at space-X. , USA " required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
